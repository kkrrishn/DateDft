package com.krrishn.aaosikhe.datedft_lib;

public class DateDft {
    private int new_Year,new_Month,new_DateOfMonth;
    private int old_Year,old_Month,old_DateOfMonth;
    private int Year,Month,DayOfMonth;
    DateDft(int new_Year,int new_Month,int new_DateOfMonth,int old_Year, int old_Month,int old_DateOfMonth){
    ...
    public DateDft(String newDate, String oldDate, String Format){
        boolean flag=true;
